...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset("admin/app-assets/css-rtl/pages/timeline.css")}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{asset("admin/app-assets/css-rtl/core/menu/menu-types/vertical-content-menu.css")}}">
  <link rel="stylesheet" type="text/css" href="{{asset("admin/app-assets/css-rtl/core/colors/palette-gradient.css")}}">
        ...
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a href="index.html"><i class="fas fa-credit-card"></i><span class="menu-title" data-i18n="nav.dash.main">Students Questions</span></a>
              ...
              <li class="{{ Route::currentRouteName() == "add_slider" ? 'active':'' }}"><a class="menu-item" href="{{ route("add_slider") }}" data-i18n="nav.dash.ecommerce">ادارة الاعلانات  </a>
              </li>
