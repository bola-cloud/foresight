                          ...
                          <form class="form" wire:submit.prevent="create_question">
                              <div class="form-body">
                                  ...
                                  <div class="row">
                                                          ...
                                                          @if($type == "block")
                                                              <div class="col-md-12">
                                                                  <div class="form-group">
                                                                      <label for="projectinput1">الوحدات</label>
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="projectinput1">الإجابة أ</label>
                                              <input type="text" id="projectinput1" class="form-control" placeholder="الإجابة أ"
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="projectinput1">الإجابة ب</label>
                                              <input type="text" id="projectinput1" class="form-control" placeholder="الإجابة ب"
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="projectinput1">الإجابة ج</label>
                                              <input type="text" id="projectinput1" class="form-control" placeholder="الإجابة ج"
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                              <label for="projectinput1">الإجابة د</label>
                                              <input type="text" id="projectinput1" class="form-control" placeholder="الإجابة د"
                                                  ...
                                                  <div class="card-body">
                                                      <fieldset class="form-group">
                                                          <select class="form-control" id="basicSelect" wire:model="true_ans">
                                                              <option value="1">اختر الإجابة</option>
