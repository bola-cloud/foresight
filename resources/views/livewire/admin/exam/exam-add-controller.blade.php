        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title" id="basic-layout-form">الاختبارات</h4>
              ...
              <div class="card-body">
                ...
                <form class="form" wire:submit.prevent="creatExam">
                  <div class="form-body">
                    ...
                    <h4 class="form-section"><i class="ft-user"></i> معلومات الاختبار</h4>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="units" class="form-control" placeholder="اسم الاختبار"
